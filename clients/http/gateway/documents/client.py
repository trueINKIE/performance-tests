...
class DocumentsGatewayHTTPClient(HTTPClient):
    ...
    def get_tariff_document_api(self, account_id: str) -> Response:
        ...
        return self.get(
            ...
            extensions=HTTPClientExtension(route="/api/v1/documents/tariff-document/{account_id}")
        )
    ...
    def get_contract_document_api(self, account_id: str) -> Response:
        ...
        return self.get(
            ...
            extensions=HTTPClientExtension(route="/api/v1/documents/contract-document/{account_id}")
        )
    ...
    def get_tariff_document(self, account_id: str) -> GetTariffDocumentResponseSchema:
        ...
        :param account_id: Идентификатор счета.
        :return: Ответ от сервера (объект GetTariffDocumentResponseSchema).
        """
    ...
    def get_contract_document(self, account_id: str) -> GetContractDocumentResponseSchema:
        ...
        :param account_id: Идентификатор счета.
        :return: Ответ от сервера (объект GetContractDocumentResponseSchema).
        """
